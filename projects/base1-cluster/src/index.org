...
** Functional Requirements of Cluster
  ...
  - Configuration Server :: This machine configures all other servers in the base1 cluster
...
#+BEGIN_SRC yaml :tangle site.yml :eval no
  ---
  # This Playbook would deploy the whole base1 cluster

  - hosts: all
  roles:
    - role: common

  - hosts: configuration_server
  roles:
    - role: configuration_server
#+END_SRC

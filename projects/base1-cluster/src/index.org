#+title: The Base1 Cluster Specification
...
Depth]]) that can hopefully detect and frustrate an attacker.
 ...
 - ssh access :: All machines are accessible only via ssh key based
                 protocols, not passwords.   ssh access from a public
                 network to =root= is completely disabled. 
 ...
 - Using fail2ban :: Works with the firewall to ban IPs involved in
                     brute-force attacks.

* Design of Base1-cluster's Network

The diagram of the final design of base1-cluster is shown below:
#   Source  at 
...
src/
 ...
 approx/
   ...
   index.org  :: simple network consisting of ansible

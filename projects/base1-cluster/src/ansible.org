...
** Access to Ansible machine
   - VLEAD engineers who have their keys placed in =authorized_keys= of ansible machine can *only* access.
...
** Ansible machine must be pingable(ICMP) from everywhere.

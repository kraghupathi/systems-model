...
** Functional Requirements 
  ...
  1. <<1>> Configuration server manages itself as well as others
     listed below:
...
*** Rule for INPUT loopback packets
   *COMMENT* This rule is not working

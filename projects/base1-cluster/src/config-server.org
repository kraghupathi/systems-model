...
** Security Requirements
   4. <<sreq4>> SSH/Port 22 accessible *ONLY* from IIIT IP range.
   5. <<sreq5>> Disable root login via ssh.
   6. <<sreq6>> Limit rate of new connections on port 22.
...
|-----------------+-----------------------------------------------------------------|
| [[sreq4]]           | This is achieved by building the appropriate rules and          |
|                 | ensuring iptables service is running.                           |
|-----------------+-----------------------------------------------------------------|
| [[sreq5]]           | This is achieved by configuring the sshd_config file and        |
|                 | ensuring sshd service is running                                |
|-----------------+-----------------------------------------------------------------|
| [[sreq6]]           | This is taken care by the common role. For more information     |
|                 | refer to [[common.org]]                                             |
|-----------------+-----------------------------------------------------------------|
...
*** Rule for incoming SSH connection
    ...
    (A variable is defined in [[./common_vars.org][common_vars]]
...
*** Steps to run the test case
    From IIIT network, ssh to the config-server using command below
   #+BEGIN_SRC
...
*** Description
    Test if all ports of configuration server are blocked except for TCP port 22
*** Steps to run the test case

...
=common_vars= file which needs to be included. 
...
*** Handlers
Handlers catch the notification to restart the various services. This
service is used by ssh, mail and fail2ban.

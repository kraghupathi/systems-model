...
# sandeep 'An independent' instead of 'a independent'
...
# sandeep 'in a planned' instead of 'in an planned'
...
<<<<<<< HEAD
# sandeep the above statement is not clear
...
*** Provisioning for Base1 and Base4
    The 
# sandeep Above statement is incomplete
*** Provisioning for AWS
# sandeep This section needs to be filled    
* Design of the Cluster model
  The diagram below depicts the architecture of the systems in the
# sandeep Reference is made to a diagram that does not exist

...
*** Create DNS servers and Configure
    ...
    - Add =environment: proxy_env= in tasks/main.yaml file of the
      roles wherever a package is installed. This means package is
...
*** Run site.yaml on config-server
    ...
    - Add servers internal ips to =ossec_client_ips= variable in
      common_vars role.
    - Uncomment =ossec_client= and =rsnapshot_client= roles in
      =private-dns.yaml= and =public-dns.yaml=

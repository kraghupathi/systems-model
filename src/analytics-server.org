...
* Requirement
  ...
  below and common requirements are defined in
...
** Functional requirements
   ...
   5) Convert apache logs into csv files for every two hours by adding
      a cronjob.
...
*** Re-configured AWS cluster, for the requirements of analytics node
    *Automated*::
    ...
    router node model.
    - Analytics server configured to accept rsync over SSH (TCP:22)
    - Reverse Proxy(Source 1) configured to push the generated
      statistics to =Analytics= server at regular intervals
    - Router configured to NAT incoming SSH (TCP:22) connections from
      Source 2-IIIT-H reverse proxy (<some-variable>) to Analytics server
      (analytics_server_ip)
...
*** On BASE machines
    *Manual step*:: 
    ...
    logs to analytics node via router TCP:2222 using rsync command.
   ...
   @hourly rsync -azR -e "ssh -p 2222" /var/www/awstats/awstats* stats.vlabs.ac.in:/var/www/html/deploy-awstats/
   @hourly rsync -azR -e "ssh -p 2222" /var/log/httpd/* stats.vlabs.ac.in:/var/www/html/deploy-logs/
   #+END_EXAMPLE
** Network Diagram
...
*** From Source1 
    ...
    - AWS reverse proxy server pushes the awstats to analytics
      server's =/var/www/html/aws-awstats/= location.
*** From Source2
    - IIIT reverse proxy server pushes the apache logs to analytics
      server's =/var/www/html/deploy-logs/= location
    - IIIT reverse proxy server pushes the awstats to analytics
      server's =/var/www/html/deploy-awstats/= location

** Log file of each lab on Deploy Container
   For more details about deploy container and labs that are running
   from it go through the link [[file:~/vlead/vlead/projects/cleaning-deploy/index.org][cleanup-deploy-container]] 
   ...
   Logs of each lab were stored at
   ...
   |------+-----------------------------------+--------------------------------------|
    ...
    lab_id are actually generated from cronjob, in cronjob, grep
    command is running based on lab_id on
    =/var/log/httpd/deploy.virtual-labs.ac.in-access*=.  

    Based on =/etc/cron.hourly/00awstats= file in
    http.virtual-labs.ac.in container following table can be created:
   #+NAME: Table02
   |------+----------+--------------+----------------------------------------|
   | S.No | Lab ID   | Pattern Name | Log File Name                          |
   |------+----------+--------------+----------------------------------------|
   |    1 | cse01    | cse01        | cse01.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |    2 | cse02    | cse02        | cse02.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |    3 | cse03    | cse03        | cse03.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |    4 | cse04    | cse04        | cse04.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |    5 | cse05    | cse05        | cse05.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |    7 | cse07    | cse07        | cse07.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |    8 | cse08    | cse08        | cse08.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |    9 | cse09    | cse09        | cse09.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   10 | cse10    | cse10        | cse10.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   11 | cse11    | cse11        | cse11.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   13 | cse13    | cse13        | cse13.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   14 | cse14    | cse14        | cse14.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   15 | cse15    | cse15        | cse15.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   16 | cse16    | cse16        | cse16.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   17 | cse17    | cse17        | cse17.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   18 | cse18    | cse18        | cse18.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   19 | cse19    | cse19        | cse19.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   20 | cse20    | cse20        | cse20.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   21 | cse21    | cse21        | cse21.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   22 | cse22    | cse22        | cse22.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   23 | cse23    | cse23        | cse23.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   24 | cse24    | cse24        | cse24.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   25 | cse25    | cse25        | cse25.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   26 | cse26    | cse26        | cse26.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   27 | cse27    | cse27        | cse27.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   28 | cse28    | cse28        | cse28.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   29 | cse29    | cse29        | cse29.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   30 | cse30    | cse30        | cse30.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   31 | ece01    | ece01        | ece01.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   32 | ece02    | ece02        | ece02.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   33 | ece03    | ece03        | ece03.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   34 | ece04    | ece04        | ece04.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   35 | ece05    | ece05        | ece05.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   36 | ece06    | ece06        | ece06.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   37 | ece07    | ece07        | ece07.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   38 | ece08    | ece08        | ece08.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   39 | ece09    | ece09        | ece09.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   40 | ece10    | ece10        | ece10.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   41 | ece11    | ece11        | ece11.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   42 | bio15    | bio15        | bio15.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   43 | bio16    | bio16        | bio16.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   44 | ccnsb01  | ccnsb01      | ccnsb01.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   45 | ccnsb02  | ccnsb02      | ccnsb02.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   46 | ccnsb03  | ccnsb03      | ccnsb03.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   47 | ccnsb04  | ccnsb04      | ccnsb04.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   48 | ccnsb05  | ccnsb05      | ccnsb05.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   49 | ccnsb06  | ccnsb06      | ccnsb06.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   50 | ccnsb07  | ccnsb07      | ccnsb07.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   51 | chem01   | chem01       | chem01.virtual-labs.ac.in-access_log   |
   |------+----------+--------------+----------------------------------------|
   |   52 | civil09  | civil09      | civil09.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   53 | civil13  | civil13      | civil13.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   54 | civil15  | civil15      | civil15.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   55 | civil16  | civil16      | civil16.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   56 | engg01   | engg01       | engg01.virtual-labs.ac.in-access_log   |
   |------+----------+--------------+----------------------------------------|
   |   57 | hss01    | hss01        | hss01.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   58 | hss02    | hss02        | hss02.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   59 | hss03    | hss03        | hss03.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   61 | mech04   | mech04       | mech04.virtual-labs.ac.in-access_log   |
   |------+----------+--------------+----------------------------------------|
   |   62 | mech17   | mech17       | mech17.virtual-labs.ac.in-access_log   |
   |------+----------+--------------+----------------------------------------|
   |   63 | mech18   | mech18       | mech18.virtual-labs.ac.in-access_log   |
   |------+----------+--------------+----------------------------------------|
   |   64 | phy14    | phy14        | phy14.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   65 | phy19    | phy19        | phy19.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   66 | sample1  | sample1      | sample1.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   67 | sample13 | sample13     | sample13.virtual-labs.ac.in-access_log |
   |------+----------+--------------+----------------------------------------|
   |   68 | sample16 | sample16     | sample16.virtual-labs.ac.in-access_log |
   |------+----------+--------------+----------------------------------------|
   |   69 | sample2  | sample2      | sample2.virtual-labs.ac.in-access_log  |
   |------+----------+--------------+----------------------------------------|
   |   70 | sample20 | sample20     | sample20.virtual-labs.ac.in-access_log |
   |------+----------+--------------+----------------------------------------|
   |   71 | sample21 | sample21     | sample21.virtual-labs.ac.in-access_log |
   |------+----------+--------------+----------------------------------------|
   |   72 | ece18    | ece18        | ece18.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   73 | ece19    | ece19        | ece19.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   74 | ece21    | ece21        | ece21.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   75 | ece26    | ece26        | ece26.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   76 | eee03    | eee03        | eee03.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   77 | eee05    | eee05        | eee05.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   78 | eee07    | eee07        | eee07.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   79 | eee08    | eee08        | eee08.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   80 | eee09    | eee09        | eee09.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   81 | eee10    | eee10        | eee10.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   82 | eee12    | eee12        | eee12.virtual-labs.ac.in-access_log    |
   |------+----------+--------------+----------------------------------------|
   |   83 | eerc01   | eerc01       | eerc01.virtual-labs.ac.in-access_log   |
   |------+----------+--------------+----------------------------------------|
   |   84 | eerc02   | eerc02       | eerc02.virtual-labs.ac.in-access_log   |
   |------+----------+--------------+----------------------------------------|
   |   85 | eerc03   | eerc03       | eerc03.virtual-labs.ac.in-access_log   |
   |------+----------+--------------+----------------------------------------|
   |   86 | eerc04   | eerc04       | eerc04.virtual-labs.ac.in-access_log   |
   |------+----------+--------------+----------------------------------------|
   |   87 | eerc05   | eerc05       | eerc05.virtual-labs.ac.in-access_log   |
   |------+----------+--------------+----------------------------------------|
   |   88 | eerc06   | eerc06       | eerc06.virtual-labs.ac.in-access_log   |
   |------+----------+--------------+----------------------------------------|
   |   89 | emt      | emt          | emt.virtual-labs.ac.in                 |
   |------+----------+--------------+----------------------------------------|

** Log files of each lab hosted on IIIT Infrastructure
   The following table shows the labs that are hosted on IIIT
   infrastructure.Refer file =/etc/httpd/conf.d/virtualhosts.conf= on
   CTID 12159 http.virtual-labs.ac.in located on base2. These labs are
   actually moved from deploy container and hosted in separate
   containers.
   ...
   #+NAME: Table03   
   |------+---------+------------------------+---------------------------------------|
   | S.no | Lab ID  | Lab Name               | Log File name                         |
   |------+---------+------------------------+---------------------------------------|
   |    1 | cse04   | Problem                | cse04.virtual-labs.ac.in-access_log   |
   |      |         | Solving                |                                       |
   |------+---------+------------------------+---------------------------------------|
   |    2 | cse06   | Data Mining            | cse06.virtual-labs.ac.in-access_log   |
   |      |         |                        |                                       |
   |------+---------+------------------------+---------------------------------------|
   |    3 | cse07   | Databases              | cse07.virtual-labs.ac.in-access_log   |
   |      |         |                        |                                       |
   |------+---------+------------------------+---------------------------------------|
   |    4 | cse09   | Linux Lab              | cse09.virtual-labs.ac.in-access_log   |
   |      |         |                        |                                       |
   |------+---------+------------------------+---------------------------------------|
   |    5 | cse05   | Principles of          | cse05.virtual-labs.ac.in-access_log   |
   |      |         | Programming            |                                       |
   |      |         | Languages              |                                       |
   |------+---------+------------------------+---------------------------------------|
   |    6 | cse13   | Advanced VLSI          | cse13.virtual-labs.ac.in-access_log   |
   |      |         |                        |                                       |
   |------+---------+------------------------+---------------------------------------|
   |      | cse16   | Speech Signal          | cse16.virtual-labs.ac.in-access_log   |
   |    7 |         | Processing             |                                       |
   |      |         | (IIIT-H)               |                                       |
   |------+---------+------------------------+---------------------------------------|
   |    8 | cse17   | Mobile Robotics        | cse17.virtual-labs.ac.in-access_log   |
   |      |         |                        |                                       |
   |------+---------+------------------------+---------------------------------------|
   |    9 | cse21   | Optical Remote         | cse21.virtual-labs.ac.in-access_log   |
   |      |         | Sensing                |                                       |
   |------+---------+------------------------+---------------------------------------|
   |      | cse24   | Natural Language       | cse24.virtual-labs.ac.in-access_log   |
   |   10 |         | Processing             |                                       |
   |------+---------+------------------------+---------------------------------------|
   |      | cse30   | Analog CMOS VLSI       | cse30.virtual-labs.ac.in-access_log   |
   |   11 |         | Circuit Design         |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   12 | eerc02  | Soil Mechanics         | eerc02.virtual-labs.ac.in-access_log  |
   |      |         |                        |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   13 | eerc04  | Basic Structural       | eerc04.virtual-labs.ac.in-access_log  |
   |      |         | Analysis               |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   14 | eerc05  | Geotechnical           | eerc05.virtual-labs.ac.in-access_log  |
   |      |         | Engineering Lab        |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   15 | cse23   | Computational          | cse23.virtual-labs.ac.in-access_log   |
   |      |         | Linguistics            |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   16 | cse10   | Computer               | cse10.virtual-labs.ac.in-access_log   |
   |      |         | Organization and       |                                       |
   |      |         | Architecture           |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   17 | civil13 | Urban Transportation   | civil13.virtual-labs.ac.in-access_log |
   |      |         | Systems Planning       |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   18 | ccnsb01 | Molecular Fluorescence | ccnsb01.virtual-labs.ac.in-access_log |
   |      |         | Spectroscopy           |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   19 | ccnsb02 | Colloid and Surface    | ccnsb02.virtual-labs.ac.in-access_log |
   |      |         | Chemistry              |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   20 | ccnsb03 | Molecular Absorption   | ccnsb03.virtual-labs.ac.in-access_log |
   |      |         | Spectroscopy           |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   21 | ccnsb04 | Quantum Chemistry      | ccnsb04.virtual-labs.ac.in-access_log |
   |      |         |                        |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   22 | ccnsb05 | Circular Dichroism     | ccnsb05.virtual-labs.ac.in-access_log |
   |      |         | Spectroscopy           |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   23 | ccnsb07 | Molecular              | ccnsb07.virtual-labs.ac.in-access_log |
   |      |         | Interactions           |                                       |
   |------+---------+------------------------+---------------------------------------|
   |   24 | cse28   | Advanced Network       | cse28.virtual-labs.ac.in-access_log   |
   |      |         | Technologies           |                                       |
   |      |         |                        |                                       |
   |------+---------+------------------------+---------------------------------------|
   |      | cse08   | Software               | cse08.virtual-labs.ac.in-access_log   |
   |   25 |         | Engineering            |                                       |
   |------+---------+------------------------+---------------------------------------|
...
** Log files of each lab hosted on AWS
   ...
   - Log Pattern :: Log Pattern is just a pattern name of the logs of
                    each lab
                    
		    Example :: Typically one lab might have many logs
                    based on date and time. So that, using log
                    pattern we can combine all logs into one file
                    called *Log File Name* 
   #+NAME: Table04   
   |------+--------------+----------------------------------------------------------------------------------+----------------------------------------------+-------------------------------------------------|
...
#Allow incoming connections from http container on base2 on TCP port 22 via the router with NAT rule for tcp port 2222
...
- name: Copying analytics_http.conf to analytics server
  ...
  notify:
   - restart apache
# Cron job for converting logs into csv files.
- name: Adding cronjob for converting logs into .csv files
  cron: 
        name=logs_to_csv
        user=root
        minute=03
        state=present
        job="python /var/www/html/analytics/logs_to_csv.py"
#+END_SRC
*** Setup org-mode8 

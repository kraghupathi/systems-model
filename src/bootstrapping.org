...
** Create all servers/nodes
   - Create a file called =cluster.sh= and add the following shell
     ...
     name. Also update bridges names *br0* and *br1*
     accordingly. Bridge "br0" is for public interface and bridge
     "br1" is for private interface. This shell script creates all

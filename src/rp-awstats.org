...
- name: Enable forwarding of ErrorLog to rsyslog
  linefile: line='ErrorLog "||/usr/bin/logger -t http_error"' regexp='^ErrorLog "||/usr/bin/logger -t http_error"' state=present insertafter="^ErrorLog logs/"

- name: Enable forwarding of CustomLog to rsyslog
  lineinfile: line='CustomLog "||/usr/bin/logger -t http_access"' regexp='^CustomLog "||/usr/bin/logger -t http_access"' state=present insertafter="^CustomLog logs/"

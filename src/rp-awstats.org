...
- name: Enable forwarding of ErrorLog to rsyslog
  lineinfile: dest=/etc/httpd/conf/httpd.conf line='ErrorLog "||/usr/bin/logger -t http_error"' regexp='^ErrorLog "||/usr/bin/logger -t http_error"' state=present insertafter="^ErrorLog "

- name: Enable forwarding of CustomLog to rsyslog
  lineinfile: dest=/etc/httpd/conf/httpd.conf line='CustomLog "||/usr/bin/logger -t http_access" combined' regexp='^CustomLog "||/usr/bin/logger -t http_access" combined' state=present insertafter="^CustomLog "

...
- Note :: If you are working on BASE1/BASE4, Please change *if
          condition* of the following template according to your
          domain name of reverse proxy which is defined in [[./common_vars.org][common_vars
          role]]. if not, you will not be able to view the awstats from
          browser.

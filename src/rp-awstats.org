...
- Apparatus :: 
            + Two containers 
              ...
              2) container with lab deployed
            + /etc/hosts
              to add hostnames of the labs, so these names are used
              in virtual-hosts.
              for name resolving internally 
            + PC/extra container
              to test reverseproxy is working or not using browser
- 

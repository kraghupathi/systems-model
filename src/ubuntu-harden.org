...
* Introduction
  ...
  audit.  
* Requirements
  1. Harden Ubuntu-OS by configuring certain operating system files.
     This hardening makes the OS more secure.
...
#+END_SRC
** Create application service hosts
   create following service hosts file:
...
10.100.1.6
#+END_SRC
** Confgure os hardening in application services

...
* Test Cases
** Test Case-1
*** Link: http://help.papertrailapp.com/kb/configuration/troubleshooting-remote-syslog-reachability/
*** Objective: Test rsyslog server's firewall rules to accept incoming connections on port UDP 514
*** Apparatus:
1) Rsyslog server
2) Rsyslog client

...
* Introduction
  ...
  # Please specify what the central node in the cluster
  # is. Describe a bit more about why this node is important, why it
...
** Security Requirements
  ...
  # remove the number 1. Because there is only one point.
* Design
...
|------+-----------+-------------------------+--------------------|
# change the description heading to purpose. Also describe what each
# file is meant for. Very crisp and short sentence. Refer privateDNS.
# also change the heading from system files to the same as in
# private-dns.
...
** Firewall Rules
   ...
   applied.
# replace "systems" with "nodes" in the second sentence.
*** Firewall Rules

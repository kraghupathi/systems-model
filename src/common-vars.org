#+Title: Common Vars Role Design Model and Implementation
...
** Generate yml files of common_vars role
   ...
   The value of variables such as "zone_names" in the roles depend
   upon what cluster is setup. For example the FQDN for labs hosted on
   base1 is "cse05.base1.virtual-labs.ac.in" and the FQDN for labs
   hosted on aws is "cse05.virtual-labs.ac.in".

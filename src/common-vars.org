...
management_ips:
  - 14.139.82.6/32
  - 196.12.53.133/32
# http_container variable is used to get logs from reverse proxy of IIITH infrastructure 
http_container: 196.12.53.130
...
proxy_domains:
  ...
  - {domain: "analytics-server.base1.virtual-labs.ac.in", alias: "analytics-server.base1.vlabs.ac.in"}
...
public_dns_entries:
  ...
  - { hostname: analytics-server, ip: 10.4.14.150 }
...
private_dns_entries:
  ...
  - { hostname: ads, ip: 10.100.1.9 }
  - { hostname: rsnapshot-server, ip: 10.100.1.10 }
  - { hostname: analytics-server, ip: 10.100.1.13 }
  - { hostname: git-server, ip: 10.4.12.185 }
...
proxy_domains:
  ...
  - {domain: "analytics-server.base4.virtual-labs.ac.in", alias: "analytics-server.base4.vlabs.ac.in"}
awstats_domains:
...
private_dns_entries:
  ...
  - { hostname: analytics-server, ip: 10.100.1.12}
...
public_dns_entries:
 ...
 - { hostname: analytics-server, ip: 10.4.14.200 }
#+END_SRC

...
#prefix variable used in almost all ansible script. This variable is used to set the cluster name
prefix: ""

#Define cluster name to be used by hooks service to set environment path
cluster: ""

#Set the IP adress of host-machine. This is needed only when using OpenVZ  as Virtualization.
hostmachine_ip: ""

#Set the password of hostmachine. This is needed only when using OpenVZ  as Virtualization.
hostmachine_password: ""

#ADS server related variables. 
consumer_key: "692236489889-a83u80r7u2oh2ng9u67d0411ao3o4ric.apps.googleusercontent.com"
consumer_secret: "QzZkM8ciJweOtvzx-93qkX4z"

...
* Introduction
  ...
  The documentation also describes the requirements, design and implementation
  of ads-hooks that are invoked by ads server to register and de-register labs.
...
*** Requirements of the hooks:: 
   ...
   - Shell script "register.sh" then writes data into lab.txt

...
*** Configure nagios server
    Configure only nagios-Server without installing other clients
...
*** Install clients in  nagios server
    Install ossec_client,rsyslog_client,nagios_client in Nagios
    server.

#+BEGIN_SRC yaml :tangle install_clients_in_nagios_server.yaml
---
- name: This yml script configures nagios server
  hosts: nagios_server
  remote_user: root
